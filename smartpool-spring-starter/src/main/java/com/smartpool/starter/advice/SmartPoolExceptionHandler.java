package com.smartpool.starter.advice;
 ...
 *   <tr><td>SmartPoolException</td><td>500</td><td>POOL-000</td></tr>
...
public class SmartPoolExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(SmartPoolExceptionHandler.class);
    ...
    /** SmartPool 通用异常 — 500 Internal Server Error */
    @ExceptionHandler(SmartPoolException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ApiResult<Void> handleSmartPool(SmartPoolException e) {
        log.error("SmartPool 异常: {}", e.getMessage(), e);
