 ...
 * @since 0.1.0
 */
@ConfigurationProperties(prefix = "smartpool")
public class SmartPoolProperties {
    ...
    public static class ThreadPool {
        private boolean enabled = true;
        private String poolName = "smartpool-thread";
    ...
    public static class DbPool {
        private boolean enabled = true;
        private String poolName = "smartpool-db";
    ...
    public static class RedisPool {
        private boolean enabled = true;
        private String poolName = "smartpool-redis";
        private int minIdle = 5;
        private int maxPoolSize = 20;
        private int maxLifetimeMinutes = 30;
        private int idleTimeoutSeconds = 600;
    ...
    public static class ObjectPool {
        private boolean enabled = true;
        private String poolName = "smartpool-object";
    ...
    public static class MemoryPool {
        private boolean enabled = true;
        private String poolName = "smartpool-memory";
        private int minIdle = 2;
