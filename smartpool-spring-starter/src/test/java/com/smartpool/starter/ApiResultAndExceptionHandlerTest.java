...
import com.smartpool.common.exception.ResourceLeakException;
import com.smartpool.common.exception.SmartPoolException;
import com.smartpool.starter.advice.SmartPoolExceptionHandler;
import com.smartpool.starter.vo.ApiResult;
...
/**
 * SPEC-16 ApiResult 和 SmartPoolExceptionHandler 测试。
 *
 * @since 0.1.0
 */
...
class ApiResultAndExceptionHandlerTest {
    ...
    @Nested
    @DisplayName("SmartPoolExceptionHandler 集成测试")
    class ExceptionHandlerIntegration {
        ...
        static class TestController {
            ...
            @GetMapping("/test/smartpool-exception")
            public String throwSmartPoolException() {
                throw new SmartPoolException("POOL-999", "General pool error");
            }
        ...
        private final MockMvc mockMvc = MockMvcBuilders
                ...
                .setControllerAdvice(new SmartPoolExceptionHandler())
                .build();
        ...
        @Test
        @DisplayName("SmartPoolException → 500")
        void shouldReturn500ForSmartPoolException() throws Exception {
            MockHttpServletResponse response = mockMvc.perform(get("/test/smartpool-exception"))
                    .andReturn().getResponse();
